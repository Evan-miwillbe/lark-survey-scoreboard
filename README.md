...
我的需求：培训后让30个人打个分，大屏上看看结果。就这么简单的事。
...
¥850能解决的问题，为什么要花¥850？飞书表格免费额度50,000行，够用到天荒地老。
...
我不是专业前端开发者。写这个项目的动机很朴素：培训结束了，领导说"做个反馈问卷"，我不想花钱买工具，也不想手动编十几道题再手动算均分。

飞书表格免费，lark-cli能操作它，AI能帮我想题目。那就把这三件事串起来。

这不是什么改变世界的伟大产品。它就是一个解决具体问题的具体方案——花了¥0，省了重复劳动，数据还在自己手里。

如果你也有类似的需求，拿去用。如果觉得哪里可以改进，提 Issue 或者直接 PR。

做工具的人，最怕工具做完了自己都不用。这个我每次培训都在用。
